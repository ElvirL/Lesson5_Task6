...
Напишите программу для бармена, который не умеет считать, чтобы по заданной дате рождения посетителя и текущей дате определить, 
...
int main(){
    ...
    cin >> date_birth;
    cout << "Введите сегодняшнюю дату (в формате - 01.01.2024): ";
    cin >> date_today;
